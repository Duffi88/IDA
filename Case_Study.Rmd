...
Nachfolgend werden alle Einzelteiltabellen in ein sauberes Datenformat überführt.
...
NA´s: Viele NA´s, die nun genauer zu untersuchen sind. Laut NATest sind NA´s in den Spalten IDNummer, Produktionsdatum, Herstellernummer, Werksnummer und Fehlerhaft.
```{r, message = FALSE}
