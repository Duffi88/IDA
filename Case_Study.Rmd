...
Die fehlerhaften Einzelteile werden ermittelt und im Anschluss gezählt.
...
NATest(K2LE2)
```
Die Struktur aller Komponententabellen bis auf K2LE2 ist richtig. Bei K2LE2 ist der erst Teil der IDNummer fehlerhaft und bedarf einer Korrektur-
